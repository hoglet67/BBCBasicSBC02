...
EQUD L8000                   \ Second processor transfer address
ENDIF
...
ELSE
EQUB L982A AND &FF \ &AD - unused
EQUB L982A AND &FF \ &AE - unused
ENDIF
...
ELSE
EQUB L982A AND &FF \ &C5 - unused
ENDIF
IF include_AUTO
EQUB L90AC AND &FF \ &C6 - AUTO
ELSE
EQUB L982A AND &FF \ &C6 - unused
ENDIF
EQUB L8F31 AND &FF \ &C7 - DELETE
IF include_LOADSAVECHAIN
EQUB LBF24 AND &FF \ &C8 - LOAD
ELSE
EQUB L982A AND &FF \ &C8 - unused
ENDIF
...
ELSE
EQUB L982A AND &FF \ &CD - unused
ENDIF
EQUB L982A AND &FF \ &CE - unused
IF include_RANDOMACCESS
EQUB LBF30 AND &FF \ &CF - PTR
ELSE
EQUB L982A AND &FF \ &CF - unused
ENDIF
...
ELSE
EQUB L982A DIV 256 \ &8E - unused
EQUB L982A DIV 256 \ &8F - unused
ENDIF
IF (VALversion<300)
...
ELSE
EQUB L982A DIV 256 \ &AD - unused
EQUB L982A DIV 256 \ &AE - unused
ENDIF
...
ELSE
EQUB L982A DIV 256 \ &C5 - unused
ENDIF
IF include_AUTO
EQUB L90AC DIV 256 \ &C6 - AUTO
ELSE
EQUB L982A DIV 256 \ &C6 - unused
ENDIF
EQUB L8F31 DIV 256 \ &C7 - DELETE
IF include_LOADSAVECHAIN
EQUB LBF24 DIV 256 \ &C8 - LOAD
ELSE
EQUB L982A DIV 256 \ &C8 - unused
ENDIF
...
ELSE
EQUB L982A DIV 256 \ &CD - unused
ENDIF
EQUB L982A DIV 256 \ &CE - unused
IF include_RANDOMACCESS
EQUB LBF30 DIV 256 \ &CF - PTR
ELSE
EQUB L982A DIV 256 \ &CF - unused
ENDIF
